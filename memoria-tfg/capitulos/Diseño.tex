...
En este capítulo se desarrolla como se ha alcanzando este objetivo. 
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    permite al dron aprender de su entorno en diferentes condiciones, dotándole de la capacidad de generalizar el comportamiento aprendido, provocando que sea capaz de funcionar correctamente
...
El resultado final de este enfoque tradicional de estos algoritmos de visión clásica se puede observar en la figura \ref{Vision_clasica}. En la parte superior de la figura se presentan diferentes segmentos
de carril: Una zona con curvas, una zona recta y una zona semirrecta. Estas imágenes representan la entrada original capturada por la cámara del dron. En la parte inferior de la figura, 
...
dificultades en la detección de las lineas, debido a que HoughLines esta optimizada para la detección de líneas rectas y no para la detección de líneas con curvas. 
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.3\textwidth}
      ...
      \caption*{d: Detección en la zona con curvas}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.3\textwidth}
      \centering
...
un minuto, mientras se teleopera con un joystick el dron por las carreteras. El resultado de la inferencia de estos modelos se puede ver en este \href{https://www.youtube.com/playlist?list=PLBmAjqsiGtfwvWz3hHlU5D6RbKCoHPxoj}{\textbf{vídeo}}, 
...
a esto, se realiza un post-procesado que se explicará a continuación, para que estos errores provenientes de la red neuronal, no afecten al posterior control del dron. 

Estos fallos en la detección se deben principalmente a que los modelos preentrenados que se proporcionan junto al YOLOP, han sido entrenados únicamente con datos reales como se 
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{figs/Diseño/YOLOP/esquema-esquema.png}
  \end{center}
...
Estos datos se recopilan utilizando un ordenador portátil (PC2) con una GPU Nvidia RTX 2070, como se menciona en la sección de \ref{sec:Arquitectura}. La tabla muestra que los 
...
se muestra una secuencia de frames recogidas en este \href{https://www.youtube.com/playlist?list=PLBmAjqsiGtfwvWz3hHlU5D6RbKCoHPxoj}{\textbf{vídeo}}
...
En la figura \ref{comparativa-PID-qlearning} se muestran varios frames recogidos en este \href{https://www.youtube.com/playlist?list=PLBmAjqsiGtfwvWz3hHlU5D6RbKCoHPxoj}{\textbf{vídeo}} de ambos comportamientos durante la trayectoria mostrando como Q-learning mantiene una trayectoria robusta y centrada 
