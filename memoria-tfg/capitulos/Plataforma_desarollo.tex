...
\begin{enumerate}
  ...
  \item \textbf{Yolop-320-320.onnx, Yolop-640-640.onnx y Yolop-1020-1020.onnx}: Estos tres archivos se han construido usandi ONNX Runtime.
\end{enumerate}
...
\begin{figure}[H]
  \begin{center}
    \subfigure[Detección de tráfico]{
     \includegraphics[scale=0.3]{figs/Plataformas_Desarollo/detect.png}
     \label{f:Detección de tráfico}}
    \subfigure[Segmentación de área transitable]{
      \includegraphics[scale=0.3]{figs/Plataformas_Desarollo/da.png}
      \label{Segmentación}}
    \subfigure[Líneas detectadas]{
      \includegraphics[scale=0.3]{figs/Plataformas_Desarollo/ll.png}
      \label{f:ll}}
 ...
 Este ejemplo se puede encontrar en la página Pytorch dedicada a la red neuronal YOLOP\footnote{\url{https://pytorch.org/hub/hustvl_yolop/}}.Por lo que, se utiliza esta red neuronal para poder detectar los carriles que puede tener las áreas transitables en Airsim.
\section{ROS}
\label{sec:ros}
...
Se utiliza ROS junto con la distribucción noetic en el desarrollo del TFG para realizar la conexión con el simulador Airsim y el desarrollo del sistema de percepción del seguimiento del carril a través del controlador PID y 
