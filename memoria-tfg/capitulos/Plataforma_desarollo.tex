...
En el caso de este TFG, se utiliza Python3 para todo el desarrollo del código junto con el middleware robotico ROS (véase la sección \ref{sec:ros}) y para el desarrollo
...
compatible para múltiples sistemas operativos como Windows, Linux, MacOS, Android e iOS, lo que hace que sea una libreria muy versátil para el desarrollo de aplicaciones en diferentes
...
colección de funciones matemáticas. Esta biblioteca es bastante utilizada en la comunidad debido a su eficiencia yidad de uso. 
