...
class QLearning:
    ...
    def algorithm(self,perception):
        ...
        self.client_airsim.simPause(False)
        file = "/home/bb6/pepe_ws/src/qlearning/trainings/14-abril/fotos/foto-episodio" + str(counter_photo) + ".jpg"
                ...
                if (points_line_right is None or points_line_left is None):
                    ...
                    #--Detect left turn
                        ...
                        if(is_first_time):
                            ...
                            if(len(points_beetween_lines) > 35800):
...
def save_files(n_episode, epsilon, steps, acummulateReward):
    ...
    with open('/home/bb6/pepe_ws/src/qlearning/trainings/14-abril/episodes-iterations.csv', mode="a", newline="") as file_steps:
        writer_steps = csv.writer(file_steps)
        writer_steps.writerow([n_episode, steps])

    with open('/home/bb6/pepe_ws/src/qlearning/trainings/14-abril/episodes-epsilon.csv', mode="a", newline="") as file_epsilon:
        writer_epsilon = csv.writer(file_epsilon)
        writer_epsilon.writerow([n_episode,epsilon])

    with open('/home/bb6/pepe_ws/src/qlearning/trainings/14-abril/episodes-accumulated-reward.csv', mode="a", newline="") as file_reward:
    ...
    df.to_csv('/home/bb6/pepe_ws/src/qlearning/trainings/14-abril/q_table.csv')
