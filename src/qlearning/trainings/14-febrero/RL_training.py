...
class QLearning:
    def __init__(self):
        ...
        self.QTable = np.genfromtxt('/home/bb6/pepe_ws/src/qlearning/trainings/14-febrero/q_table.csv', delimiter=',',skip_header=1,usecols=range(1,22))
    ...
    def is_exit_lane(self,error,cx,angle_error):
        ...
        if (cx != -1) and ((is_not_detected_left is False ) or (is_not_detected_right is False)) and (abs(angle_error) < 7.0):
           return False
...
if __name__ == '__main__':
    ...
    with open('/home/bb6/pepe_ws/src/qlearning/trainings/14-febrero/episodes-epsilon.csv', 'a') as file:
        wtr = csv.writer(file, delimiter= ' ')
        wtr.writerows(list_ep_epsilon)

    with open('/home/bb6/pepe_ws/src/qlearning/trainings/14-febrero/episodes-accumulated-reward.csv', 'a') as file:
        wtr = csv.writer(file, delimiter= ' ')
